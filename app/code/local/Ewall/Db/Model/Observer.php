 ...
 *
 */
class Ewall_Db_Model_Observer {
	protected function _getProcess() {
		return Mage::getModel('index/process')->load('ewall_db_replicator', 'indexer_code');
	}
	...
	public function afterConfigSave($observer) {
		...
		if ($configData->getResourceName() == 'core/config_data' && 
			Mage::helper('ewall_db')->isReplicatedConfigChanged($configData)) 
		{
