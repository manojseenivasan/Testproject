 ...
 *
 */
class Ewall_Db_Resource_Object_Collection extends Mage_Core_Model_Mysql4_Collection_Abstract {
	...
	public function addVirtualColumns($select, $columns = null) {
		...
		Mage::dispatchEvent('ewall_database_virtual_collection_columns', compact('entity_name', 'result', 'select', 'columns'));
