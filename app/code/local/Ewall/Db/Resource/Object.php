 ...
 *
 */
abstract class Ewall_Db_Resource_Object extends Mage_Core_Model_Mysql4_Abstract {
	...
	public function getReplicationSources() {
		...
		Mage::dispatchEvent('ewall_database_sources', compact('targetName', 'result'));
	...
	public function prepareReplicationUpdateSelects($target, $options) {
		...
		Mage::dispatchEvent('ewall_database_update_tables', compact('target', 'options'));
		Mage::dispatchEvent('ewall_database_update_columns', compact('target', 'options'));
	}
	/**
	 * Enter description here ...
	 * @param Ewall_Db_Model_Replication_Target $target
	...
	public function processReplicationUpdate($values, $options) {
		...
		Mage::dispatchEvent('ewall_database_update_process', compact('object', 'values', 'options'));
		return $object;
	}
	...
	public function prepareReplicationInsertSelects($target, $options) {
		...
		Mage::dispatchEvent('ewall_database_insert_tables', compact('target', 'options'));
		Mage::dispatchEvent('ewall_database_insert_columns', compact('target', 'options'));
	}
	/**
	 * Enter description here ...
	 * @param Ewall_Db_Model_Replication_Target $target
	...
	public function processReplicationInsert($values, $options) {
		...
		Mage::dispatchEvent('ewall_database_insert_process', compact('object', 'values', 'options'));
		return $object;
	}
	...
	public function prepareReplicationDeleteSelects($target, $options) {
		...
		Mage::dispatchEvent('ewall_database_delete_tables', compact('target', 'options'));
		Mage::dispatchEvent('ewall_database_delete_columns', compact('target', 'options'));
	}
	/**
	 * Enter description here ...
	 * @param Ewall_Db_Model_Replication_Target $target
	...
	public function processReplicationDelete($values, $options) {
		...
		Mage::dispatchEvent('ewall_database_delete_process', compact('entity_name', 'values', 'options'));
	}
	...
	public function addVirtualColumns($select, $columns = null) {
		$result = Mage::getModel('ewall_db/virtual_result');
		$this->_addVirtualColumns($result, $select, $columns);
		$entity_name = $this->getEntityName();
		Mage::dispatchEvent('ewall_database_virtual_columns', compact('entity_name', 'result', 'select', 'columns'));
	...
	public function addEditedData($object, $fields, $use_default) {
		...
		Mage::dispatchEvent('ewall_database_add_edited_data', compact('object', 'fields', 'use_default'));
	}
    ...
    public function addEditedDetails($object, $request) {
        ...
        Mage::dispatchEvent('ewall_database_add_edited_details', compact('object', 'request'));
    }
