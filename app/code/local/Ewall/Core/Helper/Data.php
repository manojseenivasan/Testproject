...
/**
 * Generic helper functions for Ewall_Core module. This class is a must for any module even if empty.
 * @author Ewall Team
 */
class Ewall_Core_Helper_Data extends Mage_Core_Helper_Abstract {
    /**
	...
	protected function _initUrlSymbols() {
		if (!$this->_urlSymbols) {
			...
			$this->_urlSymbols['-'] = Mage::getStoreConfig('ewall_filters/seo/dash');
			$this->_urlSymbols['/'] = Mage::getStoreConfig('ewall_filters/seo/slash');
			$this->_urlSymbols['+'] = Mage::getStoreConfig('ewall_filters/seo/plus');
			$this->_urlSymbols['_'] = Mage::getStoreConfig('ewall_filters/seo/underscore');
			$this->_urlSymbols["'"] = Mage::getStoreConfig('ewall_filters/seo/quote');
			$this->_urlSymbols['"'] = Mage::getStoreConfig('ewall_filters/seo/double_quote');
			$this->_urlSymbols['%'] = Mage::getStoreConfig('ewall_filters/seo/percent');
            $this->_urlSymbols['#'] = Mage::getStoreConfig('ewall_filters/seo/hash');
            $this->_urlSymbols['&'] = Mage::getStoreConfig('ewall_filters/seo/ampersand');
            $this->_urlSymbols[' '] = Mage::getStoreConfig('ewall_filters/seo/space');
        }
		return $this;
	}
