 ...
 *
 */
class Ewall_Core_Resource_Eav_Collection_Derived extends Ewall_Core_Resource_Eav_Collection {
    ...
    protected function _loadCustomItems() {
    	...
    	/* @var $collection Ewall_Core_Resource_Eav_Collection */ $collection = new $collection;
