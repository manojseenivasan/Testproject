 ...
 *
 */
class Ewall_FilterSeoLinks_Model_Rewrite extends Mage_Core_Model_Url_Rewrite {
    public function _construct() {
    	parent::_construct();
    	$this->_resourceName = 'ewall_filterseolinks/rewrite';
    }
    /** 
    ...
    public function rewrite(Zend_Controller_Request_Http $request=null, Zend_Controller_Response_Http $response=null)
    {
        ...
        $conditionalWord = $_core->getStoreConfig('ewall_filters/seo/conditional_word');
        $categorySuffix = Mage::helper('ewall_filterseolinks')->getCategoryUrlSuffix();
    ...
    protected function _getQueryParameters($parameters) {
        ...
        /* @var $_core Ewall_Core_Helper_Data */ $_core = Mage::helper(strtolower('Ewall_Core'));
		$showAllSuffix = $_core->getStoreConfig('ewall_filters/seo/show_all_suffix');
    ...
    protected function _getFilterName($seoName) {
		$vars = Mage::helper('ewall_filterseolinks')->getRewriteVars();
        if ($seoName == Mage::helper('ewall_filterseolinks')->getCategoryName()) {
    		return 'cat'; 
    	}
    	elseif(isset($vars[$seoName])) {
        	...
        	/* @var $_core Ewall_Core_Helper_Data */ $_core = Mage::helper(strtolower('Ewall_Core'));
    		$candidateNames = array($seoName, Mage::getStoreConfigFlag('ewall_filters/seo/use_label') ? $_core->urlToLabel($seoName) : $_core->lowerCased($seoName));
    		/*@var $resource Ewall_FilterSeoLinks_Resource_Rewrite */ $resource = $this->_getResource();
