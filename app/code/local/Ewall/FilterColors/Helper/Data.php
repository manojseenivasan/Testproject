...
/**
 * Generic helper functions for Ewall_FilterColors module. This class is a must for any module even if empty.
 * @author Ewall Team
 */
class Ewall_FilterColors_Helper_Data extends Mage_Core_Helper_Abstract {
    ...
    public function generateCss($filterOptions) {
        /* @var $files Ewall_Core_Helper_Files */ $files = Mage::helper(strtolower('Ewall_Core/Files'));
        $values = Mage::getResourceModel('ewall_filters/filter2_value_store_collection');
