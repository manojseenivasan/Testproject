...
class Ewall_FilterColors_Block_Grid extends Ewall_Admin_Block_Crud_Detail_Grid {
	...
	protected function _prepareCollection() {
		if (Mage::helper('ewall_admin')->isGlobal()) {
			...
			$collection = Mage::getResourceModel('ewall_filters/filter2_value_collection');
		}
		else {
			$collection = Mage::getResourceModel('ewall_filters/filter2_value_store_collection');
	...
	protected function _prepareColumns() {
		...
		$this->addColumn('color', array_merge(array(
			...
			'renderer' => 'ewall_filtercolors/column_color',
			'width' => '50px',
			...
			'default_bit' => Ewall_Filters_Resource_Filter2_Value::DM_COLOR,
		...
		$this->addColumn('normal_image', array_merge(array(
            ...
            'renderer' => 'ewall_filtercolors/column_image',
			'width' => '50px',
			'image_width' => $filter->getImageWidth(),
            'image_height' => $filter->getImageHeight(),
            'image_border_radius' => $filter->getImageBorderRadius(),
			...
			'default_bit' => Ewall_Filters_Resource_Filter2_Value::DM_NORMAL_IMAGE,
			'default_label' => $this->__('Same For All Stores'),
		)));
        $this->addColumn('selected_image', array_merge(array(
            ...
            'default_bit' => Ewall_Filters_Resource_Filter2_Value::DM_SELECTED_IMAGE,
            'default_label' => $this->__('Same For All Stores'),
        )));
        $this->addColumn('normal_hovered_image', array_merge(array(
            ...
            'default_bit' => Ewall_Filters_Resource_Filter2_Value::DM_NORMAL_HOVERED_IMAGE,
            'default_label' => $this->__('Same For All Stores'),
        )));
        $this->addColumn('selected_hovered_image', array_merge(array(
            ...
            'default_bit' => Ewall_Filters_Resource_Filter2_Value::DM_SELECTED_HOVERED_IMAGE,
            'default_label' => $this->__('Same For All Stores'),
        )));
        $this->addColumn('state_image', array_merge(array(
             ...
             'default_bit' => Ewall_Filters_Resource_Filter2_Value::DM_STATE_IMAGE,
             'default_label' => $this->__('Same For All Stores'),
         )));
    ...
    public function getGridUrl() {
    	return Mage::helper('ewall_admin')->getStoreUrl('*/*/tabColorsGrid', 
