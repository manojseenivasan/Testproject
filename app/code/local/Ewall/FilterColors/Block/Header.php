 ...
 *
 */
class Ewall_FilterColors_Block_Header extends Ewall_Admin_Block_Crud_Card_Form {
	protected function _prepareForm() {
		...
		Mage::helper('ewall_core/js')->options('edit-form', array('subforms' => array('#mf_colors_header' => '#mf_colors_header')));
		...
		$field = $fieldset->addField('image_width', 'text', array(
			...
			'name' => 'image_width',
			'required' => true,
			'default_bit' => Ewall_Filters_Resource_Filter2::DM_IMAGE_WIDTH,
		...
		$field = $fieldset->addField('image_height', 'text', array(
			...
			'name' => 'image_height',
			'required' => true,
			'default_bit' => Ewall_Filters_Resource_Filter2::DM_IMAGE_HEIGHT,
			'default_label' => Mage::helper('ewall_admin')->isGlobal() 
				? $this->__('Use System Configuration') 
				: $this->__('Same For All Stores'),
		));
		...
		$field = $fieldset->addField('image_border_radius', 'text', array(
			...
			'required' => true,
			'default_bit' => Ewall_Filters_Resource_Filter2::DM_IMAGE_BORDER_RADIUS,
			'default_label' => Mage::helper('ewall_admin')->isGlobal() 
				? $this->__('Use System Configuration') 
				: $this->__('Same For All Stores'),
		));
        ...
        $field = $fieldset->addField('image_normal', 'text', array_merge(array(
            ...
            'default_bit' => Ewall_Filters_Resource_Filter2::DM_IMAGE_NORMAL,
            'default_label' => $this->__('Same For All Stores'),
        )));
        $field->setRenderer($this->getLayout()->getBlockSingleton('ewall_filtercolors/field_image'));
        ...
        $field = $fieldset->addField('image_selected', 'text', array_merge(array(
            ...
            'default_bit' => Ewall_Filters_Resource_Filter2::DM_IMAGE_SELECTED,
            'default_label' => $this->__('Same For All Stores'),
        )));
        $field->setRenderer($this->getLayout()->getBlockSingleton('ewall_filtercolors/field_image'));
        ...
        $field = $fieldset->addField('image_normal_hovered', 'text', array_merge(array(
            ...
            'default_bit' => Ewall_Filters_Resource_Filter2::DM_IMAGE_NORMAL_HOVERED,
            'default_label' => $this->__('Same For All Stores'),
        )));
        $field->setRenderer($this->getLayout()->getBlockSingleton('ewall_filtercolors/field_image'));
        ...
        $field = $fieldset->addField('image_selected_hovered', 'text', array_merge(array(
            ...
            'default_bit' => Ewall_Filters_Resource_Filter2::DM_IMAGE_SELECTED_HOVERED,
            'default_label' => $this->__('Same For All Stores'),
        )));
        $field->setRenderer($this->getLayout()->getBlockSingleton('ewall_filtercolors/field_image'));
        ...
        $field = $fieldset->addField('state_width', 'text', array(
            ...
            'name' => 'state_width',
            'required' => true,
            'default_bit' => Ewall_Filters_Resource_Filter2::DM_STATE_WIDTH,
            'default_label' => Mage::helper('ewall_admin')->isGlobal()
                ? $this->__('Use System Configuration')
                : $this->__('Same For All Stores'),
        ));
        ...
        $field = $fieldset->addField('state_height', 'text', array(
            ...
            'name' => 'state_height',
            'required' => true,
            'default_bit' => Ewall_Filters_Resource_Filter2::DM_STATE_HEIGHT,
            'default_label' => Mage::helper('ewall_admin')->isGlobal()
                ? $this->__('Use System Configuration')
                : $this->__('Same For All Stores'),
        ));
        ...
        $field = $fieldset->addField('state_border_radius', 'text', array(
            ...
            'required' => true,
            'default_bit' => Ewall_Filters_Resource_Filter2::DM_STATE_BORDER_RADIUS,
            'default_label' => Mage::helper('ewall_admin')->isGlobal()
                ? $this->__('Use System Configuration')
                : $this->__('Same For All Stores'),
        ));
        ...
        $field = $fieldset->addField('state_image', 'text', array_merge(array(
            ...
            'default_bit' => Ewall_Filters_Resource_Filter2::DM_STATE_IMAGE,
            'default_label' => $this->__('Same For All Stores'),
        )));
        $field->setRenderer($this->getLayout()->getBlockSingleton('ewall_filtercolors/field_image'));
