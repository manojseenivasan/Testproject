 ...
 *
 */
class Ewall_FilterAdvanced_Block_Form extends Ewall_Admin_Block_Crud_Card_Form {
    protected function _prepareForm() {
        ...
        Mage::helper('ewall_core/js')->options('edit-form', array('subforms' => array('#mf_advanced' => '#mf_advanced')));
