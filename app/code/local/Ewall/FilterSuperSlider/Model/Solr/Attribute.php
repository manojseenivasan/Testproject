 ...
 *
 */
class Ewall_FilterSuperSlider_Model_Solr_Attribute extends Ewall_Filters_Model_Solr_Attribute {
    ...
    public function getExistingValues() {
        ...
        foreach ($this->getItems() as $item) {
            $urlValue = $item['value'];
            if (((string)Mage::getConfig()->getNode('modules/Ewall_FilterSeoLinks/active')) == 'true' &&
                Mage::helper('ewall_core')->getRoutePath() != 'catalogsearch/result/index')
            {
