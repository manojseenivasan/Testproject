 ...
 */
/**
 * Generic helper functions for Ewall_FilterSuperSlider module. This class is a must for any module even if empty.
 * @author Ewall Team
 */
class Ewall_FilterSuperSlider_Helper_Data extends Mage_Core_Helper_Abstract {
