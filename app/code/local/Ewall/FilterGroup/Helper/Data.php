 ...
 */
/**
 * Generic helper functions for Ewall_FilterGroup module. This class is a must for any module even if empty.
 * @author Ewall Team
 */
class Ewall_FilterGroup_Helper_Data extends Mage_Core_Helper_Abstract {
    /**
     * @param $result
     * @param $filterBlocks
     * @return array
    ...
    public function getAttributeGroups($filterBlocks) {
        ...
        $groups = Mage::getResourceModel('ewall_filtergroup/group')->getFilterableAttributeGroups();
