 ...
 *
 */
class Ewall_Filters_Model_Source_Display extends Ewall_Core_Model_Source_Abstract {
	...
	protected function _getAllOptions() {
		...
		foreach ($core->getSortedXmlChildren(Mage::getConfig()->getNode('ewall_filters/display'), $this->_filterType) as $key => $options) {
