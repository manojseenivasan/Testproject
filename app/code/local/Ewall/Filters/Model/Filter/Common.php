 ...
 *
 */
class Ewall_Filters_Model_Filter_Common
{
    /**
     * @var Ewall_Filters_Interface_Filter_Model
     */
    protected $_model;

    public function __construct(Ewall_Filters_Interface_Filter_Model $model) {
        $this->_model = $model;
    }

    #region Ewall_Filters_Interface_Filter_Query methods
    /**
