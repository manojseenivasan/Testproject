 ...
 * @author Ewall Team
 * Injected instead of standard catalog/layer_filter_attribute in Ewall_Filters_Block_Filter_Attribute constructor.
 */
class Ewall_Filters_Model_Filter_Attribute
    ...
    implements Ewall_Filters_Interface_Filter
{
    ...
    protected function _getItemsData()
    {
        ...
        if ($data === null) {
            ...
            usort($data, array(Mage::getSingleton('ewall_filters/sort'), $sortMethod));
