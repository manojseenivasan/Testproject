 ...
 * @author Ewall Team
 * Injected instead of standard catalog/layer_filter_attribute in Ewall_Filters_Block_Filter_Category constructor.
 */
class Ewall_Filters_Model_Filter_Category
    ...
    implements Ewall_Filters_Interface_Filter
{
     ...
     * @return Ewall_Filters_Model_Filter_Category
     */
    public function addCountToCategories($categories, $products = null, $inCurrentCategory = false) {
        ...
        if (count($items)) {
            ...
            if (!$category->hasProductCount()) {
                Mage::helper('ewall_filters')->addCountToCategories($products, $categories, $inCurrentCategory);
            }
        }
        return $this;
    }
