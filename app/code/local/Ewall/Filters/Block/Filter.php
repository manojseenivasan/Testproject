 ...
 * @author Ewall Team
 * Injected into layout instead of standard catalog/layer_filter_attribute in Ewall_Filters_Block_View_Category::_initBlocks.
 */
class Ewall_Filters_Block_Filter extends Mage_Catalog_Block_Layer_Filter_Abstract {
    ...
    protected function _initFilter() {
        if ($filter = Mage::getSingleton('ewall_filters/repository')->getFilter($this->getFilterOptions()->getCode())) {
            $this->_filter = $filter;
        }
        else {
            ...
            Mage::getSingleton('ewall_filters/repository')->setFilter($this->getFilterOptions()->getCode(), $this->_filter);
        }
        return $this;
    }
