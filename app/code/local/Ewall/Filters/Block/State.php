 ...
 * @author Ewall Team
 */
class Ewall_Filters_Block_State extends Mage_Catalog_Block_Layer_State {
	public function getClearUrl() {
        if ($this->getMode() == 'this') {
            ...
            return Mage::helper('ewall_filters')->getClearUrl();
        }
	}
    public function __construct()
    {
        parent::__construct();
        $this->setTemplate('ewall/filters/state.phtml');
    }
    public function getValueHtml($item) {
        $result = new Varien_Object();
        $block = $this;
        Mage::dispatchEvent('ewall_filter_value_html', compact('block', 'item', 'result'));
