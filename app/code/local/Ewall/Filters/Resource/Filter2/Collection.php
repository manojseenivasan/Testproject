...
/**
 * This resource model handles DB operations with a collection of models of type Ewall_Filters_Model_Filter2. All 
 * database specific code for operating collection of Ewall_Filters_Model_Filter2 should go here.
 * @author Ewall Team
 */
class Ewall_Filters_Resource_Filter2_Collection extends Ewall_Db_Resource_Object_Collection
{
    /**
