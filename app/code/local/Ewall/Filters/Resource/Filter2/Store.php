...
/**
 * This resource model handles DB operations with a single model of type Ewall_Filters_Model_Filter2_Store. All 
 * database specific code for Ewall_Filters_Model_Filter2_Store should go here.
 * @author Ewall Team
 */
class Ewall_Filters_Resource_Filter2_Store extends Ewall_Filters_Resource_Filter2 {
    /**
	...
	protected function _construct() {
        $this->_init(strtolower('Ewall_Filters/Filter2_Store'), 'id');
        $this->_isPkAutoIncrement = false;
    }   
	protected function _getReplicationSources() {
		return array('ewall_filters/filter2', 'core/store', 'eav/attribute');
	}
	/**
	...
	protected function _processReplicationUpdate($object, $values, $options) {
        ...
        if (!Mage::helper('ewall_db')->hasOverriddenValue($object, $values, Ewall_Filters_Resource_Filter2::DM_OPERATION)) {
            $object->setOperation($values['operation']);
        }
        if (!Mage::helper('ewall_db')->hasOverriddenValue($object, $values, Ewall_Filters_Resource_Filter2::DM_IS_REVERSE)) {
