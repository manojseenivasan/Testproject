 ...
 */
class Ewall_Filters_Resource_Filter_Decimal extends Mage_Catalog_Model_Resource_Eav_Mysql4_Layer_Filter_Decimal {
    /**
     * @param Mage_Catalog_Model_Resource_Eav_Mysql4_Product_Collection $collection
     * @param Ewall_Filters_Model_Filter_Attribute $model
     * @return Ewall_Filters_Resource_Filter_Decimal
     */
    ...
    /**
     * @param Mage_Catalog_Model_Resource_Eav_Mysql4_Product_Collection $collection
     * @param Ewall_Filters_Model_Filter_Decimal $model
     * @param array $value
     * @return Ewall_Filters_Resource_Filter_Decimal
     */
